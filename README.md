...
| Primary focus | registry contracts, admin access, legacy adapters |
...
- This repo currently publishes `@platform/admin-contracts` as the legacy compatibility package id while the migration to `@gutu/admin-contracts` is completed.
